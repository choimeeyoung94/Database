...
/*
    ...
    R       118.6615
*/
SELECT rating, AVG(length) AS ave_length
FROM film
GROUP BY rating
...
/*
    ...
    158
*/
SELECT COUNT(*) five_letter_names
FROM customer
...
/*
    ...
    599
*/
SELECT count(*) feb_2006_customers
FROM customer
