...
*/
INSERT INTO tbl_book VALUES(1, '축구의 역사', '굿스포츠', 7000);
INSERT INTO tbl_book VALUES(2, '축구 아는 여자', '나이스북', 13000);
INSERT INTO tbl_book VALUES(3, '축구의 이해', '대한미디어', 22000);
INSERT INTO tbl_book VALUES(4, '골프 바이블', '대한미디어', 35000);
INSERT INTO tbl_book VALUES(5, '피켜 교본', '굿스포츠', 6000);
INSERT INTO tbl_book VALUES(6, '역도 단계별 기술', '굿스포츠', 6000);
INSERT INTO tbl_book VALUES(7, '야구의 추억', '이상미디어', 20000);
INSERT INTO tbl_book VALUES(8, '야구를 부탁해', '이상미디어', 13000);
INSERT INTO tbl_book VALUES(9, '올림픽 이야기', '삼성당', 7500);
INSERT INTO tbl_book VALUES(10, '올림픽 챔피언', '나이스북', 13000);
...
WHERE orderd_at BETWEEN '2020-07-05' AND '2020-07-09';
...
SELECT o.order_id AS 구매번호, c.cust_name AS 구매자, b.book_name AS 책이름, (b.price * o.amount) AS 총구매액, (o.orderd_at) AS 주문일자
FROM tbl_order o
JOIN tbl_customer c ON o.cust_id = c.cust_id
JOIN tbl_book b ON o.book_id = b.book_id
WHERE o.orderd_at NOT BETWEEN '2020-07-04' AND '2020-07-07'
ORDER BY o.order_id;
...
*/
SELECT c.cust_name AS 고객명, b.book_name AS 책이름, o.orderd_at AS 주문일자
FROM tbl_order o
JOIN tbl_customer c ON o.cust_id = c.cust_id
JOIN tbl_book b ON o.book_id = b.book_id
...
/*
    ...
    박지성  3
*/
SELECT c.cust_name, COUNT(o.book_id) AS '출판사수'
FROM tbl_customer c
JOIN tbl_order o
ON c.cust_id = o.cust_id
...
SELECT c.cust_name, SUM(b.price * o.amount) AS 총구매액, COUNT(o.order_id) AS 구매횟수
FROM tbl_customer c
